...
<!-- Generated on: 2023-11-14T07:51:19.101Z -->
...
1. Find **Host image version preference**
...
| nodejs | 18.17.x | Node.js event-based server-side javascript engine |
| python3 | 3.10.x | interactive high-level object-oriented language (default python3 version) |
| azcopy | 10.21.x | A command-line utility designed for copying data to/from Microsoft Azure Blob, File, and Table storage. (path: `/.codespaces/azcopy`) |
